...
/**
 * Dashboard\DashboardManagerBundle\Document\DashboardCommentsMedia
 */
class DashboardCommentsMedia
{
    /**
     * @var MongoId $id
     */
    ...
    { 
       ...
       // since post id is string so directory name would be string type
        ...
        $pre_upload_media_dir =  __DIR__."/../../../../web/uploads/documents/dashboard/comments/original/";
