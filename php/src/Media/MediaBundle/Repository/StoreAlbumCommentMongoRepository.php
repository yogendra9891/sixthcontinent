...
/**
 * StoreAlbumCommentMongoRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class StoreAlbumCommentMongoRepository extends DocumentRepository
{
    /*
     ...
     * @return array
     */
    public function storecommentAuthorDetails($album_id){
        // get all comments of the album to retrieve author id
        $qb = $this->dm->createQueryBuilder('MediaMediaBundle:StoreAlbumComment');
     ...
     * @return boolean
     */
    public function editStoreAlbumCommentRate($rate_id, $arrayCommentRate, $comment_id) {
        $result = $this->createQueryBuilder('StoreAlbumComments')
                ->update()
