...
/**
 * AlbumCommentMongoRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class AlbumCommentMongoRepository extends DocumentRepository
{
    ...
    public function commentAuthorDetails($album_id){
        ...
        $qb = $this->dm->createQueryBuilder('MediaMediaBundle:AlbumComment');
    ...
    public function editCommentRate($rate_id, $arrayCommentRate, $comment_id) {
        $result = $this->createQueryBuilder('UserAlbumComments')
                ->update()
