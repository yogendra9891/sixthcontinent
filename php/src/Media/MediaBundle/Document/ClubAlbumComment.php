...
class ClubAlbumComment
{
    ...
    /**
     * @var Media\MediaBundle\Document\ClubAlbumCommentRating
     */
     ...
     * Add rate
     *
     * @param Media\MediaBundle\Document\ClubAlbumCommentRating $rate
     */
    public function addRate(\Media\MediaBundle\Document\ClubAlbumCommentRating $rate)
    {
        $this->rate[] = $rate;
    }
     ...
     * @param Media\MediaBundle\Document\ClubAlbumCommentRating $rate
     */
    public function removeRate(\Media\MediaBundle\Document\ClubAlbumCommentRating $rate)
    {
