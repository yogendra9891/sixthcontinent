...
class StoreAlbumComment
{
    ...
    /**
     * @var Media\MediaBundle\Document\StoreAlbumCommentRating
     */
     ...
     * Add rate
     *
     * @param Media\MediaBundle\Document\StoreAlbumCommentRating $rate
     */
    public function addRate(\Media\MediaBundle\Document\StoreAlbumCommentRating $rate)
    {
        $this->rate[] = $rate;
    }
     ...
     * @param Media\MediaBundle\Document\StoreAlbumCommentRating $rate
     */
    public function removeRate(\Media\MediaBundle\Document\StoreAlbumCommentRating $rate)
    {
