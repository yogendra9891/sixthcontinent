...
use Notification\NotificationBundle\Services\HtmlToTextException;
...
class HtmlToTextService
{
     ...
     * @throws HtmlToTextException if the HTML could not be loaded as a {@link DOMDocument}
     */
    static function convert($html) {
            ...
            if (!$doc->loadHTML($html)) {
                    throw new HtmlToTextException("Could not load HTML - badly formed?", $html);
            }
