...
use Transaction\CitizenIncomeBundle\Entity\CiFromCitizenAffiliated;
/**
 * CiFromCitizenAffiliatedRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class CiFromCitizenAffiliatedRepository extends EntityRepository implements ICitizenIncome {
    ...
    public function getTotalUsers($time_end_transaction = null, $sixc_transaction_id) {
        ...
        return $this->getEntityManager()
                        ->createQuery("
                            ...
                            a.fromId as id  
                            From
                            Affiliation\AffiliationManagerBundle\Entity\AffiliationCitizen a,
                            Transaction\TransactionSystemBundle\Entity\Transaction  t
                            where a.toId = t.buyerId
    ...
    public function getTotalAmountBaseCurrency($init_time, $end_time, $sixc_transaction_id = null) {
        return $this->getEntityManager()
                        ->createQuery("
                            SELECT 
                            t.citizenAffCharge as totoal_amount_base_currency
                            From
                            Transaction\TransactionSystemBundle\Entity\Transaction  t
    ...
    public function updateHistory($hasBeenShared, $single_share, $total_user, $time_init_transaction, $time_end_transaction, $sixc_transaction_id) {
        ...
        $model = new CiFromCitizenAffiliated;
    ...
    public function increaseParentRedistribution($id_transaction) {
        $query = $this->createQueryBuilder('u')
                ...
                ->set('t.allCountryCharge', 't.allCountryCharge + t.citizenAffCharge')
                ->set('t.citizenAffCharge', '0')
