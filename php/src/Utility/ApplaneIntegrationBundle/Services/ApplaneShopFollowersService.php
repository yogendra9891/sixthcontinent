...
class ApplaneShopFollowersService {
    ...
    public function getAllLocalShops($filter)
    {
        ...
        if($shops_count > 0){
            ...
            $response = $applane_service->getShopsFollowersInfoFromApplane($shop_ids);
    ...
    */
    public function __createLog($monolog_req, $monolog_response = array()){
        $applane_service = $this->container->get('appalne_integration.callapplaneservice');
        $handler = $this->container->get('monolog.logger.applane_shops_followers_log');
    ...
    public function sendMail($map_shops)
    {
        ...
        $path_to_log_directory = __DIR__ . "/../../../../app/logs/applane_shops_followers_log-".$log_date_format.".log";
