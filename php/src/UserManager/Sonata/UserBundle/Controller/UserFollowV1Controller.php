...
class UserFollowV1Controller extends FOSRestController {
    ...
    public function postFollowusersAction(Request $request)
    {
        ...
        if($user_con){
           $res_data = array('code' => 1004, 'message' => 'ALREADY_FOLLOWED', 'data' => array());
    ...
    public function postUnfollowusersAction(Request $request)
    {
        ...
        if(!$user_con){
           $res_data = array('code' => 1006, 'message' => 'ALREADY_UNFOLLOWED', 'data' => array());
           echo json_encode($res_data);
           exit;
        }
...
//        if(!$user_cons){
//           $res_data = array('code' => 1007, 'message' => 'NO_RESULT', 'data' => array());
//           echo json_encode($res_data);
//           exit;
//        }
...
//        }
    ...
    public function postCheckfollowAction(Request $request)
    {
        ...
        if($user_con){
           $res_data = array('code' => 1004, 'message' => 'ALREADY_FOLLOWED', 'data' => array('is_follow'=>'1'));
           echo json_encode($res_data);
           exit;
        }
         $res_data = array('code' => 1005, 'message' => 'NO_FOLLOWED', 'data' => array('is_follow'=>'0'));
           echo json_encode($res_data);
           exit;
    }
