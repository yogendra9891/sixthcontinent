...
class UserAccesstokenController extends FOSRestController {
    ...
    public function getaccesstokenAction(Request $request) {
       ...
       $em = $this->getDoctrine()->getManager();
        ...
        if(!$results){
            ...
            $resp_data = array('code' => '10', 'message' => 'INVALID_REQUEST', 'data' => $data);
        ...
        //we get fb_login at the time of facebook login.
        //if we get fb_login then skip checking of user password 
        if(!isset($de_serialize['fb_login'])) {
            //check for password
       ...
       if(isset($de_serialize['fb_login'])){
           $this->user_toAccessTokenMapping($new_acesstoken, $from_user->getId());
       }
