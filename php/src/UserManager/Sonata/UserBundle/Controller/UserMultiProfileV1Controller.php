...
class UserMultiProfileV1Controller extends FOSRestController {
    ...
    */
    public function postViewmultiprofilesAction(Request $request) {
        ...
        if ($user_check_enable == false) {
            $res_data = array('code' => 1003, 'message' => 'ACCOUNT_IS_NOT_ACTIVE', 'data' => array());
            return $res_data;
        }

        //check for profile type
        $allow_profile_type = array('1', '2' ,'4');
        if (!in_array($profile_type, $allow_profile_type)) {
            $data = array('code' => 1024, 'message' => 'INVALID_PROFILE_TYPE', 'data' => array());
            echo $this->encodeData($data);
            exit;
        }
    ...
    public function getCitizenProfile($user_id)
    {
       ...
       if(!$citizenUser){
           $data = array('code' => 1039, 'message' => 'RECORD_DOES_NOT_EXISTS', 'data' => array());
           echo $this->encodeData($data);
           exit;
       }
        //get user info
    ...
    */
    ...
    public function postUpdatemultiprofilesAction(Request $request)
    {
       ...
       //basic user info
       $de_serialize['firstname'] = isset($de_serialize['firstname']) ? $de_serialize['firstname'] : $base_user_result->getFirstname();
       $de_serialize['lastname'] = isset($de_serialize['lastname']) ? $de_serialize['lastname'] : $base_user_result->getLastname();
       $de_serialize['birthday'] = isset($de_serialize['birthday']) ? $de_serialize['birthday'] : $base_user_result->getDateOfBirth()->format('Y-m-d H:i:s');
       $de_serialize['gender'] = isset($de_serialize['gender']) ? $de_serialize['gender'] : $base_user_result->getGender();
       $de_serialize['country'] = isset($de_serialize['country']) ? $de_serialize['country'] : $base_user_result->getCountry();
       $de_serialize['state'] = isset($de_serialize['state']) ? $de_serialize['state'] : $base_user_result->getState();
       $de_serialize['hobbies'] = isset($de_serialize['hobbies']) ? $de_serialize['hobbies'] : $base_user_result->getHobbies();
       $de_serialize['relationship'] = isset($de_serialize['relationship']) ? $de_serialize['relationship'] : $base_user_result->getRelationship();
       $de_serialize['about_me'] = isset($de_serialize['about_me']) ? $de_serialize['about_me'] : $base_user_result->getAboutMe();
       $de_serialize['city_born'] = isset($de_serialize['city_born']) ? $de_serialize['city_born'] : $base_user_result->getCityBorn();
       ...
       //citizen info
       $de_serialize['region'] = isset($de_serialize['region']) ? $de_serialize['region'] : $citizen_user_result->getRegion();
       $de_serialize['city'] = isset($de_serialize['city']) ? $de_serialize['city'] : $citizen_user_result->getCity();
       $de_serialize['address'] = isset($de_serialize['address']) ? $de_serialize['address'] : $citizen_user_result->getAddress();
       $de_serialize['zip'] = isset($de_serialize['zip']) ? $de_serialize['zip'] : $citizen_user_result->getZip();
       $de_serialize['map_place'] = isset($de_serialize['map_place']) ? $de_serialize['map_place'] : $citizen_user_result->getMapPlace();
       $de_serialize['latitude'] = isset($de_serialize['latitude']) ? $de_serialize['latitude'] : $citizen_user_result->getLatitude();
       $de_serialize['longitude'] = isset($de_serialize['longitude']) ? $de_serialize['longitude'] : $citizen_user_result->getLongitude();
