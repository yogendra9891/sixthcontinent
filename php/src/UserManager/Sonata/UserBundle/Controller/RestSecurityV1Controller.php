 ...
 */
class RestSecurityV1Controller extends FOSRestController {
     ...
     * @return void
     */
    protected function loginUser($user) { echo 234; die();
     ...
     */
    public function postLoginsAction(Request $request) { echo 345345; die();
        ...
        if (!$user) {
            $res_data = array('code' => 1028, 'message' => 'USERNAME_OR_PASSWORD_IS_WRONG', 'data' => $data);
        ...
        //get user profile image
         ...
         $response_array = array(
             ...
             'verication_status' => $verification_status
