	...
	*/
    ...
    { 
       ...
       //Code end for getting the request
        ...
        //getting the posts sender ids.
        $tagged_user_ids = array_map(function($posts) {
        ...
        $tagged_user_ids = $this->array_flatten($tagged_user_ids);
        ...
        if (count($post_ids)) {
            ...
            $users_array = array_unique(array_merge($post_sender_user_ids, $comment_user_ids, $tagged_user_ids));
   ...
   public function getEditClubPostObject($object_info)
    {
        ...
        */
        ...
        if(isset($object_info->content_share)){
        $posts->setContentShare($object_info->content_share);
        }
        $dm->persist($posts);
        $dm->flush();
    ...
    */
    ...
    public function getLastPostDetail($object_info)
    {
        ...
        */
        ...
        $posts->setShareType($object_data->share_type);
        $posts->setContentShare($object_data->content_share);
        $posts->setShareObjectId($object_data->object_id);
        $posts->setShareObjectType($object_data->object_type);
        $dm->persist($posts);
        $dm->flush();
