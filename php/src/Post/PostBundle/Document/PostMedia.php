...
class PostMedia
{
    ...
    public function getUploadDir()
    {
        ...
        return 'uploads/documents/groups/posts/original/';
    }
    ...
    public function upload($MediaPostId,$key,$medianame)
    { 
       // create directory having title of postId. 
       // since post id is string so directory name would be string type
        $source= $_FILES['post_media']['tmp_name'][$key];
        $pre_upload_media_dir =  __DIR__."/../../../../web/uploads/documents/groups/posts/original/";
        ...
        if (file_exists($upload_media_dir) && is_dir($upload_media_dir)) { 
          move_uploaded_file($source, $upload_media_dir . $medianame);
        } 
        else { 
